...
const BenefitLayouts = () => {
  return (
    <section className="max-w-6xl py-12 mx-auto benefits">
      <div className="flex flex-row items-center gap-x-24">
        <div className="flex flex-row items-center">
          <img
            src="https://res.cloudinary.com/dnrorybws/image/upload/v1700658052/illustration_2_cikxvb.png"
            alt=""
            className="h-[550px]"
          />
        </div>
        <div className="flex flex-col gap-y-10">
          ...
          <div className="flex flex-col gap-y-5">
            <BenefitCard title="$880 Mio" description="Company budget saved">
              <svg
            ...
            <BenefitCard title="450,392" description="All servers available">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="47"
                height="46"
              ...
              >
                ...
                />
                <path
                  d="M23.5 18.5917L21.6983 21.735C21.2958 22.425 21.6217 23 22.4267 23H24.5733C25.3783 23 25.7042 23.575 25.3017 24.265L23.5 27.4083"
                  stroke="#640EF1"
                  strokeWidth="3"
                  strokeLinecap="round"
                  strokeLinejoin="round"
